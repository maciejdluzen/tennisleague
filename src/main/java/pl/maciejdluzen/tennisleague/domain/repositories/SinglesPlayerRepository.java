...
public interface SinglesPlayerRepository extends JpaRepository<SinglesPlayer, Long> {
    ...
    @Transactional
    @Modifying
    @Query(value = "INSERT INTO singles_players(active, first_name, last_name, phone_number, ntrp, group_id, round_id, user_id, matches_won, matches_lost, sets_won, total_points, notes) VALUES\n" +
