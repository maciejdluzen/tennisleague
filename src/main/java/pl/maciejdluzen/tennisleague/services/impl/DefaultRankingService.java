...
public class DefaultRankingService implements RankingService {
    ...
    public RankingByGroupsDTO getGroupRanking(Long id) {
        Group group = groupRepository.findWithSinglesPlayersAndMatchesByIdOrderBySinglePlayersTotalPointsDesc(id);
        ModelMapper mapper = new ModelMapper();
