            ...
            <div class="column is-4">
                <form:form method="post" modelAttribute="newMatch">
                    <div class="field">
                        ...
                        <div class="select">
                            <form:select path="groupId" items="${allgroups}" itemLabel="name" itemValue="id"/>
                        </div>
                    </div>
                    <div class="field">
                        <label class="label">Wybór zawodnika 1</label>
                        <div class="select">
                            <form:select path="playerOneId" items="${allsinglesplayers}" itemLabel="lastName" itemValue="id"/>
                        </div>
                    </div>
                    <div class="field">
                        <label class="label">Wybór zawodnika 2</label>
                        <div class="select">
                            <form:select path="playerTwoId" items="${allsinglesplayers}" itemLabel="lastName" itemValue="id"/>
                        </div>
                    </div>
